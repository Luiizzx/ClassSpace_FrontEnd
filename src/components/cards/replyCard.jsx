...
export function ReplyCard({ reply }){
  return(
    <div className="flex flex-col rounded-md w-full border border-gray-400">
      <div className="flex flex-col items-start justify-start w-full pl-2 py-1 border-b border-gray-400">
      ...
      <div className="flex items-center justify-start rounded-b-md w-full pl-2 py-5 bg-gray-200">
